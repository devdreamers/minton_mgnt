...
export default function LoginPage() {
  ...
  return (
    <section className="card" style={{ maxWidth: 560, margin: "0 auto" }}>
      ...
      <h1 style={{ marginTop: 12 }}>소셜 로그인으로 시작합니다.</h1>
      <p className="muted">
        별도 회원가입 없이 소셜 계정으로 로그인할 수 있습니다. 로그인 후 회원
        정보가 생성되며 관리자 승인 전까지 pending 상태로 남습니다.
      </p>

      <div className="stack" style={{ marginTop: 24 }}>
        <div className="subtle" style={{ textAlign: "center" }}>일반 회원 로그인</div>
